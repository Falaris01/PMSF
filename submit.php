  ...
  ['.$hostUrl.']('.$hostUrl.'?lat='.$gym['lat'].'&lon='.$gym['lon'].') | [Google Maps](<https://www.google.com/maps?q='.$gym['lat'].','.$gym['lon'].'>)',
    ...
    if ( $sendWebhookQuest === true ) {
        ...
        */
        ...
        $interestingRewards = ["Bummelz", "Chaneira", "Dratini", "Elektek", "Golbit", "Jurob", "Koknodon", "Kokowei", "Lade-TM", "Lapras", "Larvitar", "Nincada", "Pandir", "Sandan", "Schilterus", "Sichlor", "Sniebel", "Tangela", "Vipitis"];
